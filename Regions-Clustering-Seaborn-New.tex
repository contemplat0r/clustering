...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}cross\PYZus{}corr\PYZus{}matrix = scaled\PYZus{}with\PYZus{}dropped\PYZus{}regions\PYZus{}hier\PYZus{}concantenated\PYZus{}df.corr()}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Ранг модели: 1
Точность: 0.958 (среднеквадратичное отклонение: 0.042)
Значения параметров:
...
Ранг модели: 2
Точность: 0.955 (среднеквадратичное отклонение: 0.009)
Значения параметров:
...
Ранг модели: 3
Точность: 0.953 (среднеквадратичное отклонение: 0.015)
Значения параметров:
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Feature ranking:
1. feature 10 (0.296617)
2. feature 11 (0.255976)
3. feature 7 (0.106652)
4. feature 1 (0.069571)
5. feature 9 (0.064104)
6. feature 14 (0.052467)
7. feature 13 (0.046818)
8. feature 2 (0.022225)
9. feature 16 (0.017932)
10. feature 8 (0.012570)
11. feature 4 (0.010314)
12. feature 12 (0.009678)
13. feature 15 (0.007993)
14. feature 6 (0.006746)
15. feature 5 (0.006392)
16. feature 17 (0.005247)
17. feature 0 (0.005131)
18. feature 3 (0.003567)
...
Год:  2005
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2006
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2007
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_5.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2008
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_7.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2009
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_9.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2010
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_11.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2011
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_13.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2012
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_15.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2013
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_17.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Год:  2014
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Regions-Clustering-Seaborn-New_files/Regions-Clustering-Seaborn-New_121_19.png}
    \end{center}
    { \hspace*{\fill} \\}
