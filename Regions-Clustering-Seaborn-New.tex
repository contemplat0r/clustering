...
в 2005 - к \verb'"нулевому"', в 2006 - ко \verb'"второму"', а в
остальные годы - к \verb'"первому"') а может и всё время оставаться в
...
\verb'"обучения без учителя"' K-Means). Создаём экземпляр класса
...
обращаясь уже к \verb'"обученному"' (произведшему класстеризацию)
...
\verb'"важные"' показатели. Мы можем для этого использовать полученную
...
\verb'"путешествовать"' по кластерам). Далее можно попробовать сделать
...
от \verb'"степени интернатизации"'. Глядя на изображение можно сделать
